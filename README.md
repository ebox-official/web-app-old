...
If you want to compile for GH pages run `ng build --output-path docs --base-href /web-app/ --configuration development`. Then go in the `docs/`, make a copy of index.html are rename it into 404.html.
